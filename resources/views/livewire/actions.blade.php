                ...
                <form class="p-4 md:p-5">
                    <div class="">
                        <div class="col-span-2 my-4">
                            <label for="type_investiment_id" class="block mb-2 text-sm font-medium text-gray-900
                            dark:text-white">Category</label>
                            <select id="type_investiment_id" name="type_investiment_id" wire:model="form.type_investiment_id" class="g-gray-50 border
                            ...
                            @foreach($typeInvestiments as $investiment)
                                    <option value="{{$investiment->id}}">{{$investiment->name}}
                                        <small>({{100/$investiment->percentage}}%)</small></option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-span-2 my-4">
                            <label for="active_code" class="block mb-2 text-sm font-medium text-gray-900
                            dark:text-white">Active Code</label>
                            <input type="text" name="active_code" id="active_code" class="bg-gray-50 border
                            border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600
                            focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500
                            dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500
                            dark:focus:border-primary-500" wire:model="form.active_code"
                                   placeholder="ABDR11"
                                   required="">
                        ...
                        <div class="flex flex-row justify-between items-center my-4">
                            <div>
                                ...
                                dark:text-white">Price</label>
                                    <input type="text" name="price" id="price" class="bg-gray-50 border
                                border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600
                                focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500
                                dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500
                                dark:focus:border-primary-500" wire:model="form.price"
                                           placeholder="10,30"
                                           required="">
                            </div>
                            <div>
                                <label for="last_dividend" class="block mb-2 text-sm font-medium text-gray-900
                            dark:text-white">Dividend</label>
                                <input type="text" name="last_dividend" id="last_dividend" class="bg-gray-50 border
                            border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600
                            focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500
                            dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500
                            dark:focus:border-primary-500" wire:model="form.last_dividend"
                                       placeholder="R$ 0,10"
                                       required="">
                            </div>
                        </div>
                        <div class="flex flex-row justify-between items-center my-4">
                            <div>
                                <label for="total_quotas_contributed" class="block mb-2 text-sm font-medium text-gray-900
                                dark:text-white">Your Quotas</label>
                                <input type="number" name="total_quotas_contributed" id="total_quotas_contributed"
                                       class="bg-gray-50 border
                                border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600
                                focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500
                                dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500
                                dark:focus:border-primary-500" wire:model="form.total_quotas_contributed"
                                       placeholder="38"
                                       required="">
                            </div>
